...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JAMES] = REMATCH(TRAINER_JAMES_1, TRAINER_JAMES_2, TRAINER_JAMES_3, TRAINER_JAMES_4, TRAINER_JAMES_5, MAP_SCRAPPLE_HOLLOW),
    ...
    [REMATCH_MATTHEW_VR] = REMATCH(TRAINER_MATTHEW_VR_2, TRAINER_MATTHEW_VR_3, TRAINER_MATTHEW_VR_4, TRAINER_MATTHEW_VR_5, TRAINER_MATTHEW_VR_5, MAP_VICTORY_ROAD_1F),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_ROXANNE_1, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_WAWA_PARK),
    ...
    [REMATCH_NORMAN] = REMATCH(TRAINER_NORMAN_1, TRAINER_NORMAN_2, TRAINER_NORMAN_3, TRAINER_NORMAN_4, TRAINER_NORMAN_5, MAP_GIANTS_REACH),
...
// This applies to the Elite Four and Victory Road Matthew (if he's not been defeated yet)
static inline bool32 IsRematchForbidden(s32 rematchTableId)
{
    if (rematchTableId >= REMATCH_ELITE_FOUR_ENTRIES)
        return TRUE;
    else if (rematchTableId == REMATCH_MATTHEW_VR)
        return !FlagGet(FLAG_DEFEATED_MATTHEW_VICTORY_ROAD);
    else
        return FALSE;
}
