...
{
    if (IsLastHealLocation(HEAL_LOCATION_TRASHBURG_MAYS_HOUSE)
        || IsLastHealLocation(HEAL_LOCATION_TRASHBURG_MAYS_HOUSE_2F)
        || IsLastHealLocation(HEAL_LOCATION_TRASHBURG_BRENDANS_HOUSE)
        || IsLastHealLocation(HEAL_LOCATION_TRASHBURG_BRENDANS_HOUSE_2F))
        return TRUE;
