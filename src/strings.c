...
// Nuzlocke strings
const u8 gText_NuzlockeCatchable[] = _("This POKéMON is catchable!");
...
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. FRANK's POKéDEX rating!\pPROF. FRANK: Let's see…\p");
...
const u8 gText_FrankInTrouble[] = _("PROF. FRANK is in trouble!\nRelease a POKéMON and rescue him!");
...
const u8 *const gBagMenu_ReturnToStrings[] =
{
    ...
    [ITEMMENULOCATION_MATTHEW]               = gText_TheBattle,
...
const u8 gText_MenuPalGrey[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}GREY");
const u8 gText_MenuPalBlue[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}BLUE");
const u8 gText_MenuPalRed[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}RED");
const u8 gText_MenuPalGreen[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}GREEN");
