...
static const mapsec_u16_t sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_SCRAPPLE_HOLLOW,            MAPSEC_ROUTE_104},
...
{
    [MAPSEC_TRASHBURG] = {MAP_GROUP(MAP_TRASHBURG), MAP_NUM(MAP_TRASHBURG), HEAL_LOCATION_TRASHBURG_BRENDANS_HOUSE_2F},
    [MAPSEC_OLD_SCUMPORT] = {MAP_GROUP(MAP_OLD_SCUMPORT), MAP_NUM(MAP_OLD_SCUMPORT), HEAL_LOCATION_OLD_SCUMPORT},
    ...
    [MAPSEC_GIANTS_REACH] = {MAP_GROUP(MAP_GIANTS_REACH), MAP_NUM(MAP_GIANTS_REACH), HEAL_LOCATION_GIANTS_REACH},
    ...
    [MAPSEC_WAWA_PARK] = {MAP_GROUP(MAP_WAWA_PARK), MAP_NUM(MAP_WAWA_PARK), HEAL_LOCATION_WAWA_PARK},
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_TRASHBURG:
        return FlagGet(FLAG_VISITED_TRASHBURG) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OLD_SCUMPORT:
        return FlagGet(FLAG_VISITED_OLD_SCUMPORT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_GIANTS_REACH:
        return FlagGet(FLAG_VISITED_GIANTS_REACH) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_WAWA_PARK:
        return FlagGet(FLAG_VISITED_WAWA_PARK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_TRASHBURG;
    for (mapSecId = MAPSEC_TRASHBURG; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_TRASHBURG:
        return (gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_TRASHBURG_BRENDANS_HOUSE : HEAL_LOCATION_TRASHBURG_MAYS_HOUSE);
    case MAPSEC_EVER_GRANDE_CITY:
