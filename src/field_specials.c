...
bool32 ShouldDoMatthewCall(void)
{
    if (FlagGet(FLAG_ENABLE_FIRST_MATTHEW_POKENAV_CALL))
    {
        ...
        case MAP_TYPE_OCEAN_ROUTE:
            if (++(*GetVarPointer(VAR_MATTHEW_CALL_STEP_COUNTER)) < 250)
                return FALSE;
            break;
        default:
            return FALSE;
...
void LoadMatthewZigzagoon(void)
{
    u16 monData;
...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        MAP_OLD_SCUMPORT_POKEMON_CENTER_1F,
        MAP_DEWFORD_TOWN_POKEMON_CENTER_1F,
        MAP_LAVARIDGE_TOWN_POKEMON_CENTER_1F,
        MAP_FALLARBOR_TOWN_POKEMON_CENTER_1F,
        MAP_VERDANTURF_TOWN_POKEMON_CENTER_1F,
        MAP_PACIFIDLOG_TOWN_POKEMON_CENTER_1F,
        MAP_GIANTS_REACH_POKEMON_CENTER_1F,
        MAP_SLATEPORT_CITY_POKEMON_CENTER_1F,
        MAP_MAUVILLE_CITY_POKEMON_CENTER_1F,
        MAP_WAWA_PARK_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { MAP_GROUP(MAP_OLD_SCUMPORT_MART),     MAP_NUM(MAP_OLD_SCUMPORT_MART),     LOCALID_OLD_SCUMPORTMART_CLERK },
...
void ResetHealLocationFromDewford(void)
{
    if (gSaveBlock1Ptr->lastHealLocation.mapGroup == MAP_GROUP(MAP_DEWFORD_TOWN) && gSaveBlock1Ptr->lastHealLocation.mapNum == MAP_NUM(MAP_DEWFORD_TOWN))
        SetLastHealLocationWarp(HEAL_LOCATION_GIANTS_REACH);
}
