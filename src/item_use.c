...
static const u8 sText_CantThrowPokeBall_Nuzlocke[] = _("You can only catch the first\nPOKéMON in each area!\p");
...
static bool32 IsValidLocationForVsSeeker(void)
{
    ...
    Location validIndoorLocations[] =
    {
        ...
        { MAP_GROUP(MAP_WAWA_PARK_GYM),        MAP_NUM(MAP_WAWA_PARK_GYM) },
        ...
        { MAP_GROUP(MAP_GIANTS_REACH_GYM),       MAP_NUM(MAP_GIANTS_REACH_GYM) },
