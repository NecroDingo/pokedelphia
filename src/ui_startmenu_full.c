...
static void StartMenuFull_VBlankCB(void)
{
    ...
    TransferPlttBuffer();
    ChangeBgY(2, 64, BG_COORD_SUB); // controls the background scrolling - reduced from 128 to 32 for slower scroll
}
...
static bool8 StartMenuFull_LoadGraphics(void) // Load the Tilesets, Tilemaps, Spritesheets, and Palettes for Everything
{
    ...
    case 1:
        ...
        {
            LZ77UnCompWram(sStartMenuTilemap, sBg1TilemapBuffer);
