...
static void CB2_SaveFailedScreen(void)
{
    ...
    default:
        ...
        DecompressDataWithHeaderVram(gFrankBagTilemap, (void *)(BG_SCREEN_ADDR(14)));
        DecompressDataWithHeaderVram(gFrankGrassTilemap, (void *)(BG_SCREEN_ADDR(15)));
        ...
        ResetTasks();
        ResetPaletteFade();
        LoadPalette(gFrankBagGrass_Pal, BG_PLTT_ID(0), 2 * PLTT_SIZE_4BPP);
