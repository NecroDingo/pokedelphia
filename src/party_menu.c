...
// FIELD_MOVE enum is now defined in include/constants/field_move.h
...
static void DisplayPartyPokemonNickname(struct Pokemon *mon, struct PartyMenuBox *menuBox, u8 c)
{
    ...
    if (GetMonData(mon, MON_DATA_SPECIES) != SPECIES_NONE)
    {
        ...
        DisplayPartyPokemonBarDetail2(menuBox->windowId, nickname, 0, menuBox->infoRects->dimensions);
    }
}
