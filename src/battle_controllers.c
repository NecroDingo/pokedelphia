...
void SetUpBattleVarsAndFrankZigzagoon(void)
{
    ...
    {
        ZeroEnemyPartyMons();
        CreateMon(&gEnemyParty[0], SPECIES_RATTATA, 3, USE_RANDOM_IVS, 0, 0, OT_ID_PLAYER_ID, 0);
        i = 0;
        ...
        || (isLink && !isDouble))
    {
        ...
        else
        {
            ...
            if (isRecorded)
                ...
                gBattlerControllerFuncs[gBattlerPositions[B_BATTLER_0]] = SetControllerToMatthew;
            else if (isAIvsAI)
...
static inline bool32 IsControllerMatthew(u32 battler)
{
    return (gBattlerControllerEndFuncs[battler] == MatthewBufferExecCompleted);
}
...
static bool8 ShouldDoSlideInAnim(u32 battler)
{
    ...
    if (gBattleTypeFlags & (
        ...
        BATTLE_TYPE_SAFARI | BATTLE_TYPE_MATTHEW_TUTORIAL | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_TWO_OPPONENTS |
...
{
    if ((gBattleTypeFlags & (BATTLE_TYPE_SAFARI | BATTLE_TYPE_MATTHEW_TUTORIAL))
