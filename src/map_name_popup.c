...
{
    [MAPSEC_TRASHBURG] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OLD_SCUMPORT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SCRAPPLE_HOLLOW] = MAPPOPUP_THEME_WOOD,
...
{
    [MAPSEC_TRASHBURG] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OLD_SCUMPORT] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_SCRAPPLE_HOLLOW] = MAPPOPUP_THEME_BW_DEFAULT,
