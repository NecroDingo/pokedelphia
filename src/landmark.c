...
static const u8 LandmarkName_ScrappleHollow[] = _("SCRAPPLE HOLLOW");
...
static const struct Landmark Landmark_ScrappleHollow = {LandmarkName_ScrappleHollow, -1};
