...
const u32 gTrainerFrontPic_Matthew[] = INCBIN_U32("graphics/trainers/front_pics/matthew.4bpp.smol");
const u16 gTrainerPalette_Matthew[] = INCBIN_U16("graphics/trainers/palettes/matthew.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_MATTHEW, gTrainerFrontPic_Matthew, gTrainerPalette_Matthew),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MATTHEW, 4, gTrainerBackPic_Matthew, gTrainerPalette_Matthew, sBackAnims_Hoenn),
