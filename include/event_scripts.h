...
extern const u8 EventScript_DoNoIntroTrainerBattleNoWhiteout[];
...
//player pc
extern const u8 Trashburg_BrendansHouse_2F_EventScript_TurnOffPlayerPC[];
extern const u8 Trashburg_MaysHouse_2F_EventScript_TurnOffPlayerPC[];
...
extern const u8 Trashburg_BrendansHouse_2F_EventScript_PC[];
extern const u8 Trashburg_MaysHouse_2F_EventScript_PC[];
...
extern const u8 MauvilleCity_EventScript_RegisterMatthewCall[];
extern const u8 Route119_EventScript_ScottWonAtFortreeGymCall[];
extern const u8 Trashburg_ProfessorFranksLab_EventScript_ScottAboardSSTidalCall[];
extern const u8 WawaPark_Gym_EventScript_RegisterRoxanne[];
