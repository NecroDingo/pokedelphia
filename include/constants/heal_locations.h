...
enum {
    HEAL_LOCATION_NONE,
    HEAL_LOCATION_TRASHBURG_BRENDANS_HOUSE_2F,
    HEAL_LOCATION_TRASHBURG_MAYS_HOUSE_2F,
    HEAL_LOCATION_GIANTS_REACH,
    HEAL_LOCATION_SLATEPORT_CITY,
    HEAL_LOCATION_MAUVILLE_CITY,
    HEAL_LOCATION_WAWA_PARK,
    ...
    HEAL_LOCATION_TRASHBURG_BRENDANS_HOUSE,
    HEAL_LOCATION_TRASHBURG_MAYS_HOUSE,
    HEAL_LOCATION_OLD_SCUMPORT,
