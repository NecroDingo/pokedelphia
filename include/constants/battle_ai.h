...
#define AI_FLAG_EXPERT_TRAINER        (AI_FLAG_SMART_TRAINER | AI_FLAG_PREDICTION | AI_FLAG_HP_AWARE | AI_FLAG_RISKY | AI_FLAG_TRY_TO_2HKO | AI_FLAG_POWERFUL_STATUS | AI_FLAG_CONSERVATIVE | AI_FLAG_PREFER_HIGHEST_DAMAGE_MOVE)
