...
enum {
    ...
    REMATCH_MATTHEW_VR,  // Entries above MATTHEW are considered normal trainers, from Matthew below are special trainers
    REMATCH_ROXANNE,
    REMATCH_BRAWLY,
    REMATCH_WATTSON,
    REMATCH_FLANNERY,
...
#define REMATCH_SPECIAL_TRAINER_START   REMATCH_MATTHEW_VR
