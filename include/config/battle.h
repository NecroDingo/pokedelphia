...
#define B_SMART_WILD_AI_FLAG        0x54  // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
...
#define B_FLAG_NO_WHITEOUT          FLAG_TEMP_10     // If this flag is set, the player can not white out against Trainers. Please note that the party is not healed automatically!
...
// Other settings
#define B_DOUBLE_WILD_CHANCE            4          // % chance of encountering two Pokémon in a Wild Encounter.
...
#define B_OBEDIENCE_MECHANICS           GEN_3      // In PLA+ (here Gen8+), obedience restrictions also apply to non-outsider Pokémon, albeit based on their level met rather than actual level
